                            ...
                            <div class="row">
                                <div class="col-auto">
                                    <div class="hero-slider-content">
                                        ...
                                        <a href="product-details-dynamic.php"
                                ...
                                <div class="banner-single-item banner-style-2 banner-animation img-responsive"
                                    ...
                                    <div class="content">
                                        <h4 class="title">Kitchen <br>
                                            utensils</h4>
                                        <a href="product-details-dynamic.php" class="link-text"><span>Shop
                                                now</span></a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6 col-sm-6 mb-6">
                                <div class="banner-single-item banner-style-2 banner-animation img-responsive"
                                    ...
                                    <div class="content">
                                        <h4>Interior <br>
                                            lighting</h4>
                                        <a href="product-details-dynamic.php"><span>Shop now</span></a>
                                    </div>
                                </div>
                            </div>
                            <!-- End Banner Single Item -->
                        ...
                        <div class="product-slider-default-2rows default-slider-nav-arrow">
                            ...
                            <div class="swiper-container product-default-slider-4grid-2row">
                                ...
                                <div class="swiper-wrapper">
                                    ...
                                    <!-- Start Product Default Single Item -->
                                    <?php
                                    // Retrieve the 6 most recent products from the "men's-fashion" category
                                        $sql = "SELECT * FROM `men's_fashion` ORDER BY id DESC LIMIT 6";
                                        ...
                                        if ($result->num_rows > 0) {
                                            ...
                                            while ($product = $result->fetch_assoc()) {
                                                ...
                                                // Generate a unique identifier for the "Add to Cart" link
                                                $addToCartLinkId = 'addToCartLink-' . $productId;

                                                // Generate the HTML code for the product
                                    ?>
                                    <div class="product-default-single-item product-color--golden swiper-slide">
                                        <div class="image-box">
                                            <a href="product-details-dynamic.php?id=<?php echo $product['id'];?>" class="image-link">
                                                <img src="admin/<?php echo $productImage1 ?>" style="height:250px" alt="">
                                                <img src="admin/<?php echo $productImage1 ?>" alt="">
                                            </a>
                                            <div class="tag">
                                                <span>sale</span>
                                            </div>
                                            <div class="action-link">
                                                ...
                                                <a href="#" class="addToCartLink" data-product-id="<?php echo $productId; ?>">Add to Cart</a>
                                        ...
                                        <div class="content">
                                            <div class="content-left">
                                                <h6 class="title"><a href="product-details-dynamic.php?id=<?php echo $product['id']; ?>"><?php echo $productName?></a></h6>
                                            ...
                                            <div class="content-right">
                                                <span class="price"><del>৳ 2500</del> <?php echo $productPrice ?></span>
                                            </div>
                                    ...
                                    <!-- <div class="product-default-single-item product-color--golden swiper-slide">
                                        <div class="image-box">
                                            <a href="product-details-dynamic.php" class="image-link">
                                        ...
                                        <div class="content">
                                            <div class="content-left">
                                                <h6 class="title"><a href="product-details-dynamic.php">Cras neque
                                                        metus</a></h6>
                                                <ul class="review-star">
                                                    <li class="fill"><i class="ion-android-star"></i></li>
                                                    <li class="fill"><i class="ion-android-star"></i></li>
                                    ...
                                    <!-- <div class="product-default-single-item product-color--golden swiper-slide">
                                        ...
                                        <div class="content">
                                            <div class="content-left">
                                                <h6 class="title"><a href="product-details-dynamic.php">Donec eu libero
                                                        ac</a></h6>
                                                <ul class="review-star">
                                                    <li class="fill"><i class="ion-android-star"></i></li>
                                                    <li class="fill"><i class="ion-android-star"></i></li>
                                    ...
                                    <!-- <div class="product-default-single-item product-color--golden swiper-slide">
                                        ...
                                        <div class="content">
                                            <div class="content-left">
                                                <h6 class="title"><a href="product-details-dynamic.php">Epicuri per
                                                        lobortis</a></h6>
                                                <ul class="review-star">
                                                    <li class="fill"><i class="ion-android-star"></i></li>
                                                    <li class="fill"><i class="ion-android-star"></i></li>
                                    ...
                                    <!-- <div class="product-default-single-item product-color--golden swiper-slide">
                                        ...
                                        <div class="content">
                                            <div class="content-left">
                                                <h6 class="title"><a href="product-details-dynamic.php">Kaoreet
                                                        lobortis sagit</a></h6>
                                                <ul class="review-star">
                                                    <li class="fill"><i class="ion-android-star"></i></li>
                                                    <li class="fill"><i class="ion-android-star"></i></li>
                                    ...
                                    <!-- <div class="product-default-single-item product-color--golden swiper-slide">
                                        ...
                                        <div class="content">
                                            <div class="content-left">
                                                <h6 class="title"><a href="product-details-dynamic.php">Condimentum
                                                        posuere</a></h6>
                                                <ul class="review-star">
                                                    <li class="fill"><i class="ion-android-star"></i></li>
                                                    <li class="fill"><i class="ion-android-star"></i></li>
                                    ...
                                    <!-- <div class="product-default-single-item product-color--golden swiper-slide">
                                        ...
                                        <div class="content">
                                            <div class="content-left">
                                                <h6 class="title"><a href="product-details-dynamic.php">Convallis quam
                                                        sit</a></h6>
                                                <ul class="review-star">
                                                    <li class="fill"><i class="ion-android-star"></i></li>
                                                    <li class="fill"><i class="ion-android-star"></i></li>
                                    ...
                                    <!-- <div class="product-default-single-item product-color--golden swiper-slide">
                                        ...
                                        <div class="content">
                                            <div class="content-left">
                                                <h6 class="title"><a href="product-details-dynamic.php">Dolorum fuga
                                                        eget</a></h6>
                                                <ul class="review-star">
                                                    <li class="fill"><i class="ion-android-star"></i></li>
                                                    <li class="fill"><i class="ion-android-star"></i></li>
                                    ...
                                    <!-- <div class="product-default-single-item product-color--golden swiper-slide">
                                        ...
                                        <div class="content">
                                            <div class="content-left">
                                                <h6 class="title"><a href="product-details-dynamic.php">Duis pulvinar
                                                        obortis</a></h6>
                                                <ul class="review-star">
                                                    <li class="fill"><i class="ion-android-star"></i></li>
                                                    <li class="fill"><i class="ion-android-star"></i></li>
                            ...
                            <div class="swiper-container product-default-slider-4grid-1row">
                                ...
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="product-default-single-item product-color--golden swiper-slide">
                                        ...
                                        <div class="content">
                                            <div class="content-left">
                                                <h6 class="title"><a href="product-details-dynamic.php">Aliquam
                                                        lobortis</a></h6>
                                                <ul class="review-star">
                                                    <li class="fill"><i class="ion-android-star"></i></li>
                                                    <li class="fill"><i class="ion-android-star"></i></li>
    ...
    <div class="banner-section">
        <div class="banner-wrapper clearfix">
            ...
            <div class="banner-single-item banner-style-4 banner-animation banner-color--golden float-left img-responsive"
                ...
                <a href="product-details-dynamic.php" class="content">
                    <div class="inner">
