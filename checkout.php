        ...
        <div class="container">
            ...
            <div class="checkout_form" data-aos="fade-up" data-aos-delay="400">
                ...
                <?php $userId = $_GET['userId']; 
                    $query = "SELECT name, email, address, phone FROM users WHERE id = ?";
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        // Now you can use the retrieved user information to populate the form or perform any desired actions
                    } else {
                        // User not found, handle the error as per your requirement
                    }
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="default-form-box">
                                        ...
                                        <input type="text" value="<?php echo strtoupper($name); ?>">
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="default-form-box">
                                        <label>Additional address <span>*</span></label>
                                ...
                                <div class="col-lg-6">
                                    <div class="default-form-box">
                                        ...
                                        <input type="text" value="+88 <?php echo $phone; ?>">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="default-form-box">
