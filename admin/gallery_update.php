...
$sql = "INSERT INTO gallery (image1, image2, image3, image4, image5) VALUES ('$image1_url', '$image2_url', '$image3_url', '$image4_url', '$image5_url')";
...
$result = $conn->query("SELECT id, image1, image2, image3, image4, image5 FROM gallery WHERE id != 0");
    ...
    <div class="container-fluid position-relative d-flex p-0">
            ...
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link active" data-bs-toggle=""><i class="fa fa-laptop me-2"></i>Gallery Update</a>
        ...
        <div class="content">
            ...
            <br>
                ...
                <br>
                <br><br>
                <label style="padding-right: 30px; font-weight:900; font-size: 18px;" for="image2">Image</label>
                ...
                <br>
                <br><br>
                <label style="padding-right: 30px; font-weight:900; font-size: 18px;" for="image3">Image</label>
                ...
                <br>
                <br><br>
                <label style="padding-right: 30px; font-weight:900; font-size: 18px;" for="image4">Image</label>
                ...
                <br>
                <br><br>
                <label style="padding-right: 30px; font-weight:900; font-size: 18px;" for="image5">Image</label>
            ...
            while ($row = $result->fetch_assoc()) {?>
                <img style="height: 250px; width: 320px; padding: 40px;" src="<?php echo $row['image1']?>" alt="">
                <img style="height: 250px; width: 320px; padding: 40px;" src="<?php echo $row['image2']?>" alt="">
                <img style="height: 250px; width: 320px; padding: 40px;" src="<?php echo $row['image3']?>" alt="">
                <img style="height: 250px; width: 320px; padding: 40px;" src="<?php echo $row['image4']?>" alt="">
                <img style="height: 250px; width: 320px; padding: 40px;" src="<?php echo $row['image5']?>" alt="">
